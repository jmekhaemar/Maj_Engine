...
namespace maj::rhi
{
	...
	void Texture::createSampler()
	{
		...
		samplerInfo.mipmapMode = VK_SAMPLER_MIPMAP_MODE_LINEAR; // TODO add to serialization, check for support
		samplerInfo.mipLodBias = 0.f;
		samplerInfo.minLod = 0.f;
		samplerInfo.maxLod = static_cast<float>(mImage->info().mMipLevels); // TODO add to serialization or copy from image
